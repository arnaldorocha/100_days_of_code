...
#     if not os.path.exists('cafe-data.csv'):
#         with open('cafe-data.csv', mode='w', encoding='utf-8') as file:
#             file.write("Cafe Name,Location,Opening Time,Closing Time,Coffee Rating,Wifi Rating,Power Rating\n")
